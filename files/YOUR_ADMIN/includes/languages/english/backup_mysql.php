...
define('TEXT_ZC_PLUGIN_DOWNLOAD', 'Original Plugin - Zen Cart');
define('TEXT_ZC_SUPPORT', 'Original Plugin support thread - Zen Cart Forum');
define('TEXT_GITHUB_SUPPORT', 'Support (GitHub) for this version of the Plugin');
